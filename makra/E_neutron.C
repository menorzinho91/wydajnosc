...
//=========  (Wed May  9 02:38:35 2018) by ROOT version5.34/36
   TCanvas *c1 = new TCanvas("c1", "c1",10,108,700,500);
   c1->Range(-0.275,-101377.9,2.475,912401.1);
   c1->SetFillColor(0);
   c1->SetBorderMode(0);
   c1->SetBorderSize(2);
   ...
   TH1F *htemp = new TH1F("htemp","col3 {col1==1}",100,0,2.2);
   htemp->SetBinContent(1,1786);
   htemp->SetBinContent(46,75343);
   htemp->SetBinContent(91,772403);
   ...
   text = ptstats->AddText("Mean  =  1.907");
   text = ptstats->AddText("RMS   = 0.2974");
