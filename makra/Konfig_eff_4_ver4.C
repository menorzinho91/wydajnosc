...
int Konfig_eff_4_ver4() {
	...
	int numery_plikow1[]={19,23};
	int numery_plikow2[]={29,17};
int num1;
int num2;
fstream wyniki;
...
c2->Divide(2,2);
   ...
   if( wyniki.good() == true )
   {
	...
	sprintf(nazwa2,"./Wyniki/Symulacja_%d_%d_%d.root",iter,numery_plikow1[num1],numery_plikow2[num2]);
...
for(int z=0;z<2;z++){
	...
	Double_t S_g;
fstream plik;
sprintf(nazwa,"./Wyniki/Wynik_%d_%d_%d.txt",iter,numery_plikow1[num1],numery_plikow2[num2]);
